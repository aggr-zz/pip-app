    ...
    <main style={{ minHeight: '100vh', background: 'var(--bg-page)', padding: '40px 24px 80px' }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <DocSection title="5. Защита данных детей">
          <p>
            <strong>Согласие родителя.</strong> Профиль ребёнка создаёт только родитель или
            законный представитель, и перед созданием он даёт явное согласие на обработку
            данных ребёнка. Мы фиксируем, кто и когда дал согласие. Согласие можно отозвать
            в любой момент, удалив профиль ребёнка или весь аккаунт — данные будут удалены.
          </p>
          <p>
            <strong>Что мы собираем о ребёнке:</strong> имя (можно указать любое, в том числе
            вымышленное), год рождения (необязательно, только чтобы подобрать подачу по
            возрасту), аватар (эмодзи, цвет или загруженное фото) и фотографии-подтверждения
            выполненных заданий, если задание их требует.
          </p>
          <p>
            <strong>Чего мы НЕ делаем:</strong> не показываем детям рекламу, не передаём их
            данные третьим лицам, не используем сторонние рекламные и аналитические SDK, не
            собираем геолокацию и контакты, не даём детям общаться с кем-либо вне своей семьи.
            В приложении нет ни встроенных покупок, ни реальных денег — PIP-монеты
            существуют только внутри семьи.
          </p>
          <p>
            Дети не регистрируются самостоятельно: ребёнок входит по ссылке от родителя и
            4-значному PIN. Имя и фото ребёнка видны только внутри семейного аккаунта и
            никогда не публикуются. Фотографии-подтверждения доступны только родителю и
        ...
        <DocSection title="6. Ваши права">
          <ul>
            ...
            <li><strong>Удаление:</strong> вы можете удалить аккаунт и все данные семьи прямо
            в приложении — <strong>Профиль → Удалить аккаунт</strong>. Удаление необратимо и
            происходит сразу: профили детей, задания, награды, история и все фотографии.
            Просить нас об этом не нужно.</li>
